...
class CosmosKeypair {
    ...
    static getPrivateKeyFromSecret(mnemonicS) {
        ...
        let derivedPriv = Hd.DerivePrivateKeyForPath(master.secret,master.chainCode,Config.regen.bip39Path);
        return derivedPriv;
    }
    ...
    static create(language) {
        ...
        pubKey = Amino.MarshalBinary(Config.regen.amino.pubKey,pubKey);
    ...
    static isValidAddress(address) {
        let prefix = Config.regen.bech32.accAddr;
